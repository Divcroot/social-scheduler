import { CalendarDaysIcon, LayoutDashboardIcon, LogInIcon, UserIcon, Wand2Icon } from "lucide-react"
        ...
        <nav className="flex-1 px-3 space-y-1">
            {navItems.map((item) => {
                ...
                return (
                    ...
                    className={`flex items-center gap-3 px-3 py-2.5 rounded text-sm transition-all duration-150 border ${isActive ? 'text-red-600 border-red-100' : 'text-slate-500 hover:bg-slate-50 border-transparent hover:text-slate-700'}`}>
